...
## 0.3.0
* 新增 Git文件，支持查看当前文件当前行最后一次修改信息 （将光标置于当前行，右键菜单【查看当前行最后一次修改信息 】）
* 新增 日志视图 使用插件API customEditor, 布局更合理 （HBuilderX2.9.2+版本）
* 新增 日志视图 右键菜单，增加【刷新】、【检出】、【切换分支】、【创建标签】、【重置提交】、【cherry-pick】、【复制】等功能
* 优化 文件视图 跟随vscode，将文件类型划分为: 合并更改、更改、暂存的更改
